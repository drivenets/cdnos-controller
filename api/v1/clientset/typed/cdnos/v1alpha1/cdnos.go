...
import (
	...
	scheme "github.com/drivenets/cdnos-controller/api/v1/clientset/scheme"
...
type CdnosInterface interface {
	...
	UpdateStatus(ctx context.Context, cdnos *v1alpha1.Cdnos, opts v1.UpdateOptions) (*v1alpha1.Cdnos, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.Cdnos, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.CdnosList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Cdnos, err error)
	CdnosExpansion
}
